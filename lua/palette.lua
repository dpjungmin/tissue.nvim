...
local palette = {
  ...
  base08  = '#f69d50', -- # Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  base09  = '#c38a61', -- # Integers, Boolean, Constants, XML Attributes, Markup Link Url
  base0A  = '#f0c239', -- # Classes, Markup Bold, Search Text Background
  base0B  = '#8ac361', -- # Strings, Inherited Class, Markup Code, Diff Inserted
  ...
  base0E  = '#ef8557', -- # Keywords, Storage, Selector, Markup Italic, Diff Changed
